...
const ALL_SELECTIONS = [
  ...
  {
    category: 'Plumbing Fixtures & Finishes',
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Interior Door Style', description: 'Panel style — 2, 5, or 6 panel, shaker, etc.', due_phase: 'Finishes & Trim', requires_signoff: true },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Washer & Dryer', description: 'Brand, finish, and stacking or side-by-side', due_phase: 'Finishes & Trim', requires_signoff: false },
  ...
  {
    category: 'Landscaping & Exterior Finishes',
    items: [
...
export default function NewSelectionTemplatePage() {
  ...
  async function handleSave() {
    ...
    if (template) {
      ...
      router.push(`/admin/templates/selections/${template.id}`)
    }
    setSaving(false)
  }
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1200px', margin: '0 auto' }}>
      <Link href="/admin/templates/selections" style={{ fontSize: '11px', color: '#4a4030', textDecoration: 'none', textTransform: 'uppercase', letterSpacing: '1px', display: 'inline-block', marginBottom: '16px' }}>← Selection Templates</Link>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '220px 1fr', gap: '16px' }}>
        ...
        <div style={card}>
          ...
          {items.filter(i => i.category === activeCategory).map((item, globalIdx) => {
